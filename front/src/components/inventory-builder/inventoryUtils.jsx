export const DEFAULT_WEAPON_IMAGES = {
  Classic: '/images/default_weapons/classic.png',
  Shorty: '/images/default_weapons/shorty.png',
  Frenzy: '/images/default_weapons/frenzy.png',
  Ghost: '/images/default_weapons/ghost.png',
  Sheriff: '/images/default_weapons/sheriff.png',
  Stinger: '/images/default_weapons/stinger.png',
  Spectre: '/images/default_weapons/spectre.png',
  Bucky: '/images/default_weapons/bucky.png',
  Judge: '/images/default_weapons/judge.png',
  Bulldog: '/images/default_weapons/bulldog.png',
  Guardian: '/images/default_weapons/guardian.png',
  Phantom: '/images/default_weapons/phantom.png',
  Vandal: '/images/default_weapons/vandal.png',
  Melee: '/images/default_weapons/melee.png',
  Marshal: '/images/default_weapons/marshal.png',
  Outlaw: '/images/default_weapons/outlaw.png',
  Operator: '/images/default_weapons/operator.png',
  Ares: '/images/default_weapons/ares.png',
  Odin: '/images/default_weapons/odin.png'
};
